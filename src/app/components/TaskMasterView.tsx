...
// Omit OTP from the interface here, as it's generated by App.tsx
            ...
            <div className="relative space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-xs text-[var(--campus-text-secondary)] mt-1 ml-1">
                    Amount will be held in Escrow securely.
                  </p>
                </div>
